    ...
    <ContentBlock>
      ...
      <ValidationObserver v-slot="{ handleSubmit }">
        <div class="pd-frame-1 mgt-1">
          ...
          <div class="input-group">
            <InputFile inputTitle="" refName="invoiceImage" labelText="選擇載具截圖或明細照片" @update="inputUpdate"></InputFile>
...
<script>
  ...
  import {cloudInvoice} from '@/api/index'
  export default {
    data(){
      return{
        invoiceNumber:'',
